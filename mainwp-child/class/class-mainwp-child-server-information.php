...
class MainWP_Child_Server_Information extends MainWP_Child_Server_Information_Base { //phpcs:ignore -- NOSONAR - multi methods.
    ...
    private static function render_server_infor() {
        ...
        <table id="mainwp-table-server" class="wp-list-table widefat" style="border-spacing:0;">
            ...
            <tbody id="the-sites-list" class="list:sites">
                <?php static::render_system_infor_rows( $branding_title ); ?>
                <?php static::render_php_settings_rows(); ?>
                <?php static::render_mysql_infor_rows(); ?>
                <?php static::render_server_infor_rows(); ?>
                <?php static::render_php_infor_rows(); ?>
                <?php static::render_plugins_infor_rows( $branding_title ); ?>
            </tbody>
        </table>
        <br/>
        <?php
    ...
    private static function render_system_infor_rows( $branding_title ) {
        ...
        <?php static::render_mainwp_directory(); ?>
        <tr>
            <td style="background: #333; color: #fff;" colspan="5"><?php esc_html_e( 'WordPress', 'mainwp-child' ); ?></td>
        </tr>
        <?php static::render_row( 'WordPress Version', '>=', '3.4', 'get_wordpress_version' ); ?>
        <?php static::render_row( 'WordPress Memory Limit', '>=', '64M', 'get_wordpress_memory_limit' ); ?>
        <?php static::render_row( 'MultiSite Disabled', '=', true, 'check_if_multisite' ); ?>
        <tr>
            <td></td>
            <td><?php esc_html_e( 'FileSystem Method', 'mainwp-child' ); ?></td>
            <td><?php echo esc_html( '= direct' ); ?></td>
            <td><?php echo esc_html( static::get_file_system_method() ); ?></td>
            <td><?php static::render_file_system_method_check(); ?></td>
        </tr>
        <?php
    }
    ...
    protected static function render_file_system_method_check() {
        $fsmethod = static::get_file_system_method();
        if ( 'direct' === $fsmethod ) {
    ...
    private static function render_php_settings_rows() {
        ...
        <?php static::render_row( 'PHP Version', '>=', '7.4', 'get_php_version' ); ?>
        <tr>
            <td></td>
            <td><?php esc_html_e( 'PHP Safe Mode Disabled', 'mainwp-child' ); ?></td>
            <td colspan="3"><?php static::get_php_safe_mode(); ?></td>
        </tr>
        <?php
        static::render_row_sec( 'PHP Max Execution Time', '>=', '30', 'get_max_execution_time', 'seconds', '=', '0' );
    ...
    private static function render_mysql_infor_rows() {
        ...
        <?php static::render_row( 'MySQL Version', '>=', '5.0', 'get_my_sql_version' ); ?>
        <tr>
            <td style="background: #333; color: #fff;" colspan="5"><?php esc_html_e( 'BACKUP ARCHIVE INFORMATION', 'mainwp-child' ); ?></td>
        </tr>
        <?php static::render_row( 'ZipArchive enabled in PHP', '=', true, 'get_zip_archive_enabled' ); ?>
        <?php static::render_row( 'Tar GZip supported', '=', true, 'get_gzip_enabled' ); ?>
        <?php static::render_row( 'Tar BZip2 supported', '=', true, 'get_bzip_enabled' ); ?>
        <?php
    }
    ...
    private static function render_php_infor_rows() {
        ...
        <tr>
            ...
            <td colspan="3"><?php static::get_php_allow_url_fopen(); ?></td>
        </tr>
        <tr>
            <td></td>
            <td><?php esc_html_e( 'PHP Exif Support', 'mainwp-child' ); ?></td>
            <td colspan="3"><?php static::get_php_exif(); ?></td>
        </tr>
        <tr>
            <td></td>
            <td><?php esc_html_e( 'PHP IPTC Support', 'mainwp-child' ); ?></td>
            <td colspan="3"><?php static::get_php_ip_tc(); ?></td>
        </tr>
        <tr>
            <td></td>
            <td><?php esc_html_e( 'PHP XML Support', 'mainwp-child' ); ?></td>
            <td colspan="3"><?php static::get_php_xml(); ?></td>
        </tr>
        <tr>
            <td></td>
            <td><?php esc_html_e( 'PHP Disabled Functions', 'mainwp-child' ); ?></td>
            <td colspan="3"><?php static::mainwp_required_functions(); ?></td>
        </tr>
        <tr>
            <td></td>
            <td><?php esc_html_e( 'PHP Loaded Extensions', 'mainwp-child' ); ?></td>
            <td colspan="3" style="width: 73% !important;"><?php static::get_loaded_php_extensions(); ?></td>
        </tr>
        <tr>
            <td style="background: #333; color: #fff;"
        ...
        <tr>
            ...
            <td colspan="3"><?php static::get_sql_mode(); ?></td>
        </tr>
        <tr>
            <td></td>
     ...
     * @uses \MainWP\Child\MainWP_Child_Branding::get_branding_title()
     */
    public static function render_error_log() { //phpcs:ignore -- NOSONAR - complex.
